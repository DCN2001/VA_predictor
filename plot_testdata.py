...
def plot_testdata(args):
    ...
    for song in tqdm(song_list):
        ...
        with torch.no_grad():
            ...
            predict_va = model(org_input)
        #Save the prediction to a list 
        pred_list.append(predict_va.squeeze(0).cpu())
...
if __name__ == '__main__':
    ...
    parser.add_argument('--feature_path', type=str, default='/mnt/gestalt/home/dcn2001/xrspace_testdata/feature', help="Path of the extracted testdata feature")
